              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {["Mais de 150 dinâmicas interativas de artes marciais", "Técnicas e metodologias incluídas", "Acesso digital pelo celular, tablet ou computador", "Pronto para imprimir quando quiser"].map((item, i) => <li key={i} className="flex items-start gap-2 text-sm text-muted-foreground">
