...
const CONFIG = {
  ...
  timerEndDate: new Date(new Date().setHours(23, 59, 59, 999)), // End of today
  showStickyCta: true,
};
...
const BONUS_DATA = [
  {
    ...
    description:
      "Prepare seus alunos com alongamentos específicos para prevenir lesões e melhorar o desempenho",
    value: "R$ 27",
    icon: "🧘",
  },
  {
    ...
    description:
      "Atividades lúdicas que mantêm os alunos engajados no aprendizado",
    value: "R$ 37",
    icon: "🎮",
  },
  {
    ...
    description:
      "Estimule técnica, estratégia e confiança nas artes marciais",
    value: "R$ 33",
    icon: "🎯",
  },
];
...
const TESTIMONIALS = [
  {
    ...
    quote:
      '"Sempre foi difícil manter a atenção dos alunos nas aulas. Essas dinâmicas salvaram minhas aulas! Agora eles interagem, praticam com disciplina e o aprendizado flui naturalmente."',
  ...
  },
  {
    ...
    quote:
      '"Excelente para nossa academia! O material é bem elaborado e segue metodologias modernas de ensino de artes marciais."',
    avatar: "/placeholder.svg",
  },
  {
    name: "João Silva",
    role: "Pai de Aluno",
    quote:
      '"Meu filho se apaixonou pelas artes marciais com essas atividades. Vale muito a pena! Ele pede para treinar todos os dias."',
    avatar: "/placeholder.svg",
  },
];
...
const FAQ_DATA = [
  {
    ...
    answer:
      "Após a confirmação do pagamento, você receberá imediatamente por email o acesso ao material digital em PDF. Você poderá baixar e começar a usar as dinâmicas na mesma hora!",
  },
  {
    question: "Quais formas de pagamento são aceitas?",
    answer:
      "Aceitamos cartão de crédito, débito, PIX e boleto bancário. O acesso é liberado imediatamente após a confirmação do pagamento.",
  },
  {
    question: "O material é realmente aplicável em qualquer estilo de artes marciais?",
    answer:
      "Sim! As dinâmicas foram desenvolvidas para serem adaptáveis a qualquer estilo de arte marcial, incluindo judô, jiu-jitsu, karatê, taekwondo, muay thai e outros.",
  },
  {
    question: "Posso usar o material em minha academia/escola?",
    answer:
      "Sim! O material é ideal para uso em academias, escolas e centros de treinamento. Você pode aplicar as dinâmicas em suas aulas normalmente.",
  },
  {
    question: "Como funciona a garantia de 7 dias?",
    answer:
      "Se por qualquer motivo você não ficar satisfeito com o material, basta solicitar o reembolso em até 7 dias após a compra. Devolvemos 100% do valor pago, sem perguntas.",
  },
  {
    question: "As atividades servem para que idade?",
    answer:
      "As dinâmicas foram pensadas para todas as idades, desde crianças a partir de 4 anos até adultos. O material inclui adaptações para diferentes faixas etárias e níveis de habilidade.",
  },
];
...
const UrgencyBar = ({ date }: { date: string }) => (
  <div
    className="sticky top-0 z-50 bg-gradient-to-r from-red-600 via-orange-500 to-red-600 py-2 px-4"
    role="status"
    aria-live="polite"
  >
...
const CTAButton = ({
  ...
  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
    <Button
      ...
      size={size}
      className={cn(
        "bg-emerald-600 hover:bg-emerald-700 text-white font-bold shadow-lg hover:shadow-xl transition-all duration-300 focus-visible:ring-emerald-500",
...
// Hero Section
const HeroSection = () => (
  <section className="relative py-12 md:py-20 px-4 bg-gradient-to-br from-rose-50 via-orange-50 to-rose-100">
    <div className="container max-w-5xl mx-auto text-center">
      ...
      >
        <span className="text-foreground">+150 Dinâmicas</span>
        <br />
        <span className="text-red-600">Interativas de Artes</span>
        <br />
        <span className="text-red-600">Marciais</span>
        <br />
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {[
                      "Mais de 150 dinâmicas interativas de artes marciais",
                      "Técnicas e metodologias incluídas",
          ...
          <Card className="h-full shadow-md hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-lg mb-3">Para Todas as Idades</h3>
                  <ul className="space-y-2">
                    {[
                      "Atividades pensadas para crianças, iniciantes e diferentes níveis de aprendizado",
                      "Ideal para instrutores, professores e academias de artes marciais",
                    ].map((item, i) => (
                      <li key={i} className="flex items-start gap-2 text-sm text-muted-foreground">
                        <CheckCircle className="h-4 w-4 text-emerald-500 flex-shrink-0 mt-0.5" />
                        <span>{item}</span>
...
// Bonus Section
const BonusSection = () => (
  <section className="py-16 md:py-24 px-4 bg-gradient-to-br from-rose-50 via-orange-50 to-amber-50">
    <div className="container max-w-5xl mx-auto">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
...
const PricingSection = () => {
  ...
  const basicFeatures = [
    { text: "+150 Dinâmicas Interativas de Artes Marciais PDF", included: true },
    { text: "Acesso imediato", included: true },
    { text: "Metodologia comprovada", included: true },
  ...
  const premiumFeatures = [
    ...
    { text: "Metodologia comprovada", included: true },
    { text: "Garantia de 7 dias", included: true },
    { text: "BÔNUS: 50 Alongamentos Rápidos", included: true, isBonus: true },
    { text: "BÔNUS: Jogos Interativos de Artes Marciais", included: true, isBonus: true },
    { text: "BÔNUS: 100 Questões de Artes Marciais", included: true, isBonus: true },
...
const FinalCTASection = () => (
  <section className="py-16 md:py-24 px-4 bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800">
    <div className="container max-w-3xl mx-auto">
      <motion.div
        initial={{ opacity: 0, scale: 0.95 }}
        whileInView={{ opacity: 1, scale: 1 }}
...
// Sticky Mobile CTA
const StickyCTA = () => (
  <div className="fixed bottom-0 left-0 right-0 p-3 bg-background/95 backdrop-blur border-t shadow-lg z-40 md:hidden">
    <CTAButton
      href={CONFIG.checkoutPremium}
      section="sticky"
      plan="premium"
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Acesso imediato a mais de 150 dinâmicas interativas de artes marciais para instrutores, professores e academias. Material completo em PDF + 3 bônus exclusivos."
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="+150 Dinâmicas Interativas de Artes Marciais" />
        <meta
          property="og:description"
          content="Acesso imediato a atividades interativas que estimulam técnica, disciplina e desenvolvimento."
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "Material completo em PDF com mais de 150 dinâmicas interativas de artes marciais para instrutores, professores e academias.",
            offers: [
              {
                "@type": "Offer",
                name: "Plano Básico",
