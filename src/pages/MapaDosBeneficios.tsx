            ...
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {["Benefícios para jovens, adultos e idosos.", "Sem 'juridiquês' ou termos técnicos.", "Ideal para trabalhadores, estudantes, autônomos e aposentados.", "Economize tempo e dinheiro com informações que valem ouro."].map((item, i) => <li key={i} className="flex items-start gap-2 text-sm text-muted-foreground">
                        <CheckCircle className="h-4 w-4 text-emerald-500 flex-shrink-0 mt-0.5" />
                        <span>{item}</span>
                      </li>)}
                  </ul>
