...
import { Plus, Edit, Eye, EyeOff, Trash2, Settings } from "lucide-react";
            ...
            <div 
              className={
                managementMode 
                  ...
                  : "flex animate-scroll-right group-hover:pause-animation w-max"
              }
              style={managementMode ? {} : { width: 'max-content' }}
            >
                ...
                return (
                  <div 
                    ...
                    className={
                      managementMode
                        ? "relative group"
                        : "flex-shrink-0 px-2 sm:px-4 group relative z-0 hover:z-50"
                    }
                    {...(!managementMode && {
                      onMouseEnter: (e) => {
                  ...
                  >
                    <a
                      ...
                      onClick={(e) => managementMode && e.preventDefault()}
                    >
                      <div className="relative">
                        ...
                        {managementMode && !partner.is_active && (
