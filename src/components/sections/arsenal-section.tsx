        ...
        <div className="text-center mb-12 animate-fade-in" style={{ animationDelay: "0.9s" }}>
          ...
          <Card className="p-10 md:p-12 bg-gradient-to-br from-primary/10 to-primary/5 border-2 border-primary/30 max-w-2xl mx-auto">
            <div className="space-y-6">
              ...
              <Button 
                size="lg"
                className="w-full bg-gradient-primary hover:opacity-90 shadow-purple text-base md:text-lg py-6 md:py-8 px-6 md:px-8 h-auto whitespace-normal"
              >
                <Zap className="h-5 w-5 md:h-6 md:w-6 mr-2 flex-shrink-0" />
                <span className="leading-tight text-center">SIM, QUERO ACESSO IMEDIATO E TRANSFORMAR MINHA PRODUTIVIDADE</span>
              </Button>
