    ...
    <section className="w-full py-16 md:py-24 bg-accent/20">
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto items-stretch">
          ...
          >
            <Card className="h-full border-2 hover:border-primary/40 transition-colors duration-300 shadow-lg hover:shadow-xl flex flex-col">
              <CardHeader className="space-y-3">
              ...
              <CardContent className="flex-1 flex flex-col">
                ...
                <div className="mt-auto pt-4">
                  <Button
                    variant="outline"
                    size="lg"
                    className="w-full gap-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground h-12"
